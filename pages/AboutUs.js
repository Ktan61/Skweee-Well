        ...
        <h4 tabIndex={6}>Meet Sqweee</h4>
          <div className={styles.members}>
            ...
            <div className={styles.memberBlurb}>
              <p tabIndex={8}>Sqweee is the ambassador of the Sqwell app! With his knack for finding the best acorns, Sqweee is more than just a squirrel; he's your trusty guide to navigating the Sqwell universe.</p>
            </div>
          </div>
          <br></br>
          <h4 tabIndex={9}>Sqwell Team</h4>
          <div className={styles.members}>
            <div className={styles.headShot}>
            <Image
              ...
              <div className={styles.memberBlurb}>
              <h5 tabIndex={11}>Kathryn Tan</h5>
              <p tabIndex={12}>Hello squirrel pals! I am part of the D3 program at BCIT, and am learning the ropes to be a designer and developer. With this web app, I hope to share my love for visiting parks, and biking outdoors. Thank you for visiting Sqwell!</p>
              </div>
          </div>
          <div className={styles.members}>
            <div className={styles.headShot}>
            <Image
              ...
              <div className={styles.memberBlurb}>
              <h5 tabIndex={14}>Madeline Struthers</h5>
              <p tabIndex={15}>Hello! I am a D3 student finishing my first year at BCIT. I enjoy going outside, painting, and spending quality time with friends and family. I hope to continue to develop my design skills and have a successful career as a digital designer.</p>
              </div>
          </div>
          <div className={styles.members}>
            <div className={styles.headShot}>
